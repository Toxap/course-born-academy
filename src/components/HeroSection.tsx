...
const HeroSection = () => {
  ...
  return <section id="hero" className="relative min-h-screen flex items-center justify-start overflow-hidden">
      ...
      {/* Login Button */}
      <div className="absolute top-8 right-8 z-20 px-0 py-0 my-[600px] mx-[50px]">
        <Button variant="ghost" className="text-white/80 hover:text-white hover:bg-white/10 border border-white/20 hover:border-white/40 backdrop-blur-sm">
          Войти
        </Button>
      </div>
