      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative">
            <button
              onClick={prevCourse}
              className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 bg-slate-800 rounded-lg border border-slate-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-slate-600 transition-all duration-300"
            >
            ...
            <button
              onClick={nextCourse}
              className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 bg-slate-800 rounded-lg border border-slate-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-slate-600 transition-all duration-300"
            >
            ...
            <div 
              key={currentCourse}
              className="bg-slate-800 rounded-2xl border-2 border-red-900/50 overflow-hidden shadow-xl"
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
                <div className="space-y-6">
                  ...
                  <Button className="w-full bg-red-900 hover:bg-red-800 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300">
                    Начать обучение
                  </Button>
                </div>
